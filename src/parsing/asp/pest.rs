...
impl PestParser for ConditionalHeadParser {
    ...
    type InternalParser = internal::Parser;
    type Rule = internal::Rule;
    const RULE: internal::Rule = internal::Rule::conditional_head;
...
impl PestParser for ConditionalBodyParser {
    ...
    type InternalParser = internal::Parser;
    type Rule = internal::Rule;
    const RULE: Self::Rule = internal::Rule::conditional_body;
...
impl PestParser for ConditionalLiteralParser {
    ...
    type InternalParser = internal::Parser;
    type Rule = internal::Rule;
    const RULE: internal::Rule = internal::Rule::conditional_literal;
